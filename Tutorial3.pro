...
Tutorial3RootPath=/home/bat/Projects/Unreal/Tutorial3

gameProjectFile=/home/bat/Projects/Unreal/Tutorial3/Tutorial3.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(Tutorial3Source.pri)
include(Tutorial3Header.pri)
include(Tutorial3Config.pri)
include(Tutorial3Includes.pri)
include(Tutorial3Defines.pri)
...
Tutorial3-Linux-Debug.commands = $$build Tutorial3 Linux Debug  -project="\"$$gameProjectFile\"" $$args
Tutorial3-Linux-DebugGame.commands = $$build Tutorial3 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Tutorial3-Linux-Shipping.commands = $$build Tutorial3 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Tutorial3-Linux-Test.commands = $$build Tutorial3 Linux Test  -project="\"$$gameProjectFile\"" $$args
Tutorial3.commands = $$build Tutorial3 Linux Development  -project="\"$$gameProjectFile\"" $$args

Tutorial3Editor-Linux-Debug.commands = $$build Tutorial3Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Tutorial3Editor-Linux-DebugGame.commands = $$build Tutorial3Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Tutorial3Editor-Linux-Shipping.commands = $$build Tutorial3Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Tutorial3Editor-Linux-Test.commands = $$build Tutorial3Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
Tutorial3Editor.commands = $$build Tutorial3Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Tutorial3-Linux-Debug \
	Tutorial3-Linux-DebugGame \
	Tutorial3-Linux-Shipping \
	Tutorial3-Linux-Test \
	Tutorial3 \
	Tutorial3Editor-Linux-Debug \
	Tutorial3Editor-Linux-DebugGame \
	Tutorial3Editor-Linux-Shipping \
	Tutorial3Editor-Linux-Test \
	Tutorial3Editor \
