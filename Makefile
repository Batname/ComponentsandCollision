...
Tutorial3-Linux-Debug:
	 $(PROJECTBUILD) Tutorial3 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3-Linux-DebugGame:
	 $(PROJECTBUILD) Tutorial3 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3-Linux-Shipping:
	 $(PROJECTBUILD) Tutorial3 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3-Linux-Test:
	 $(PROJECTBUILD) Tutorial3 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3:
	 $(PROJECTBUILD) Tutorial3 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3Editor-Linux-Debug:
	 $(PROJECTBUILD) Tutorial3Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3Editor-Linux-DebugGame:
	 $(PROJECTBUILD) Tutorial3Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3Editor-Linux-Shipping:
	 $(PROJECTBUILD) Tutorial3Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3Editor-Linux-Test:
	 $(PROJECTBUILD) Tutorial3Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Tutorial3Editor:
	 $(PROJECTBUILD) Tutorial3Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
